    ...
    <>
      <div className="flex flex-col items-center p-4 gap-4">
        ...
        <div className="w-full justify-start">
          <Link to={'/login'} className="button bg-green-500">Login</Link> to view your todos
        </div>
        <div className="w-full justify-start">
          <Link to={'/register'} className="w-full button bg-green-500">Register</Link> to start tracking your tasks!
        </div>
